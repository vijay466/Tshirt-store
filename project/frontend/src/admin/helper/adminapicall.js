...
export const getaSigleProduct = (productId) => {
    return fetch(`${API}product/${productId}`, {  //REACT_APP_BACKEND = http://localhost:8000/api/
        method: "GET",
...
export const updateTheProduct = (userId,token,productId,product) => {
    return fetch(`${API}product/${productId}/${userId}`, {
        method: "PUT",
        headers: {
            Accept: "application/json",
